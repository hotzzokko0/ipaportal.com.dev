...
<!-- 설문조사 시작 { -->
<form name="fpoll" action="<?php echo G5_BBS_URL ?>/poll_update.php" onsubmit="return fpoll_submit(this);" method="post" role="form">
<input type="hidden" name="po_id" value="<?php echo $po_id ?>">
<input type="hidden" name="skin_dir" value="<?php echo urlencode($skin_dir); ?>">
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title"><b>설문조사<b>
        <?php if ($is_admin == "super") {  ?><a href="<?php echo G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?php echo $po_id ?>" class="link-inverse pull-right"><i class="fa fa-cog"></i></a><?php }  ?>
        </h4>
    </div>
    ...
    <div class="panel-footer text-center">
        ...
        <a href="<?php echo G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn btn-default">결과보기</a>
    </div>
</div>
</form>
