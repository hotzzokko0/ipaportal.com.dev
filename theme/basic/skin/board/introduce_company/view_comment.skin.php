    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <bfooter>
            <ul class="bo_vc_act">
                ...
                <?php if ($list[$i]['is_del'])  { ?><li><a href="<?php echo $list[$i]['../../introduce_company/del_link'];  ?>" onclick="return comment_delete();">삭제</a></li><?php } ?>
            </ul>
        </bfooter>
        <?php } ?>
    </article>
...
<aside id="bo_vc_w">
    <h2>댓글쓰기</h2>
    <form name="fviewcomment" action="../../introduce_company/write_comment_update.php" onsubmit="return fviewcomment_submit(this);" method="post" autocomplete="off">
