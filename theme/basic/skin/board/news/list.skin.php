...
<div id="bo_list" class="fz_wrap">
	...
	<div class="col-lg-12">
        ...
        <!-- 게시판 페이지 정보 및 RSS { -->
        <?php /*?><div class="fz_header">
            <div class="fz_total_count"><span><i class="fa fa-list-alt" aria-hidden="true"></i> Total <strong><?php echo number_format($total_count) ?></strong>건</span></div>
        ...
        <div class="row">
            ...
            <form name="fboardlist" id="fboardlist" action="../fz_webzine - Copy/board_list_update.php" method="post">
            ...
            <?php if ($is_checkbox) { ?>
            <!--2017-02-23 ONVISUAL MR.KIM DELETE-->
            <?php /*?><div id="gall_allchk">
            ...
            <?php } ?>
             ...
             <!-- 게시판 검색 시작 { -->
                <fieldset id="bo_sch">
                    ...
                    <span class="select_box" style="display:none;">
                    ...
                    <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="i_text w_sbox required" size="15" maxlength="20" placeholder="분야별 뉴스 검색">
                    <input type="submit" src="<?=$board_skin_url?>/img/btn_search.gif" class="btn_search_submit" value="검색" />
            ...
            <ul class="fz_gallery_list row">
                ...
                <li class="col-sm-12 col-xs-6 <?=$wr_id == $list[$i]['wr_id'] ? " active" : ''?>">
                    ...
                    <?php /*?><span class="fz_gallery_user">
            ...
            <div class="fz_footer">
             ...
             <?php
            include_once(G5_THEME_PATH.'/aside_news.php');
            ?>
	    </div>
    </div>
