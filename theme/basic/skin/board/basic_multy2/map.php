...
// 네이버 지도api 키값
$map_key = "key=8814e5ef4993504f58de2baa7032e53a" ;
...
<!-- 네이버 지도 키 값 -->
<SCRIPT LANGUAGE="JavaScript" src="http://maps.naver.com/js/naverMap.naver?key=8814e5ef4993504f58de2baa7032e53a"></SCRIPT>
<!-- 네이버 지도 키 값 끝 -->



<!-- 지도 출력 -->
<div id='mapContainer' style="border:5px #DDDDDD solid;"></div> 
<!-- 지도 출력 끝 -->
...
<!--
	...
	var icon = new NIcon("<?=$board_skin_url?>/img/map_icon.gif", new NSize(50,50)); // 아이콘파일을 계정에 만드시고(지정된 위치에 표시되는 아이콘입니다) 이미지 주소 및 크기를 변경해주세요
