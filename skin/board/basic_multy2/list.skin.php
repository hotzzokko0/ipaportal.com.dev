...
?>
 ...
 <!-- 분류 셀렉트 박스, 게시물 몇건, 관리자화면 링크 -->
	<div style="clear:both;">
        <div style="padding:20px 10px 20px 10px;verticul-align:middle; text-align:center;border:10px solid #f3f3f3;">
    ...
    <div class="tbl_head01 tbl_wrap">
		...
		?>
				...
				if($ext1_39){
						...
						echo "</font>";
						?>
			<a href='#' onclick="javascript:window.open('<?=$board_skin_url?>/new_1.php?bo_table=<?=$bo_table?>&wr_id=<?=$list[$i][wr_id]?>', '', 'left=200, top=100, width=780, height=650, scrollbars=1');"><img src="<?=$board_skin_url?>/img/simple.gif" border=0 align=absmiddle></a>
