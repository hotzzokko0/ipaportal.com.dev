...
$ext2_00  = $ex2_filed[0]; //과목1
$ext2_01  = $ex2_filed[1]; //전임파트1
$ext2_02  = $ex2_filed[2]; //성별1
$ext2_03  = $ex2_filed[3]; //과목2
...
<br>
<font color=#BF3030><b> * 구인정보</b></font>
<table width="100%" cellpadding="0" cellspacing="1" bgcolor=#CCCCCC>
		 ...
		 <tr><td width="11%" class=write_cb>과목</td>
			...
			<td width="11%" class=write_cb>모집인원</td></tr>
		<!--1 ---------------------------------------------------------------------------------------------------------------------------------------------------------------  -->
		<tr><td class=write_fc><INPUT class="frm_input required" style="width:60px;" name='ext2_00' id='ext2_00' value="<?=$ext2_00?>" maxlength='70'  itemname="과목1" required></td>
			<td class=write_fc> <select name="ext2_01" required itemname='근무형태'>
							<option value="">선택</option>
							<option value="전임" <? if($ext2_01 == "전임")	 echo "selected"; ?>>전임</option>
							<option value="파트" <? if($ext2_01 == "파트")	 echo "selected"; ?>>파트</option>
							<option value="시간제" <? if($ext2_01 == "시간제")	 echo "selected"; ?>>시간제</option>
							<option value="보조강사" <? if($ext2_01 == "보조강사")	 echo "selected"; ?>>보조강사</option>
			...
			<td class=write_fc>
					<input name='ext1_10' class="frm_input required" style="width:30px;" value='<?=$ext1_10?>' type='text' maxlength='3' onKeyDown='onlyNumber(this);' required itemname='모집인원'>&nbsp;명</td></tr>


		<!--2  -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
		<tr><td class=write_fc><INPUT class="frm_input" style="width:60px;" name='ext2_03' id='ext2_03' value="<?=$ext2_03?>" maxlength='70'  itemname="과목2"></td>
			<td class=write_fc> <select name="ext2_10" itemname='근무형태2'>
							<option value="">선택</option>
							<option value="전임" <? if($ext2_10 == "전임")	 echo "selected"; ?>>전임</option>
							<option value="파트" <? if($ext2_10 == "파트")	 echo "selected"; ?>>파트</option>
			...
			<td class=write_fc>
					<input name='ext2_20' class="frm_input" style="width:30px;" value='<?=$ext2_20?>' type='text' maxlength='3' onKeyDown='onlyNumber(this);' itemname='모집인원'>&nbsp;명</td></tr>
	
<!--3  -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->

			<tr><td class=write_fc><INPUT class="frm_input" style="width:60px;" name='ext1_21' id='ext1_21' value="<?=$ext1_21?>" maxlength='70'  itemname="과목3"></td>
			<td class=write_fc> <select name="ext1_22" itemname='근무형태3'>
							<option value="">선택</option>
							<option value="전임" <? if($ext1_22 == "전임")	 echo "selected"; ?>>전임</option>
							<option value="파트" <? if($ext1_22 == "파트")	 echo "selected"; ?>>파트</option>
			...
			<td class=write_fc>
					<input name='ext1_29' class="frm_input" style="width:30px;" value='<?=$ext1_29?>' type='text' maxlength='3' onKeyDown='onlyNumber(this);' itemname='모집인원3'>&nbsp;명</td></tr>

	<!-- 4 -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->

	<tr><td class=write_fc><INPUT class="frm_input" style="width:60px;" name='ext1_38' id='ext1_38' value="<?=$ext1_38?>" maxlength='70'  itemname="과목4"></td>
			<td class=write_fc> <select name="ext1_30" itemname='근무형태4'>
							<option value="">선택</option>
							<option value="전임" <? if($ext1_30 == "전임")	 echo "selected"; ?>>전임</option>
							<option value="파트" <? if($ext1_30 == "파트")	 echo "selected"; ?>>파트</option>
			...
			<td class=write_fc>
					<input name='ext1_37' class="frm_input" style="width:30px;" value='<?=$ext1_37?>' type='text' maxlength='3' onKeyDown='onlyNumber(this);' itemname='모집인원4'>&nbsp;명</td></tr>

	<!--  -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->

	<tr><td class=write_fc><INPUT class="frm_input" style="width:60px;" name='ext1_39' id='ext1_39' value="<?=$ext1_39?>" maxlength='70'  itemname="과목5"></td>
			<td class=write_fc> <select name="ext1_40" itemname='근무형태5'>
							<option value="">선택</option>
							<option value="전임" <? if($ext1_40 == "전임")	 echo "selected"; ?>>전임</option>
							<option value="파트" <? if($ext1_40 == "파트")	 echo "selected"; ?>>파트</option>
			...
			<td class=write_fc>
					<input name='ext1_47' class="frm_input" style="width:30px;" value='<?=$ext1_47?>' type='text' maxlength='3' onKeyDown='onlyNumber(this);' itemname='모집인원5'>&nbsp;명</td></tr>
...
<font color=#BF3030><b> ** 학원정보</b>

		
		<table width="100%" cellpadding="0" cellspacing="1" bgcolor=#CCCCCC>
		    <tr><td width="20%" class=write_cb>학원명</td>
				  <td colspan="3" class=write_fl><INPUT class="frm_input" style="width:220;" name='ext2_18' id='ext2_18' value="<?=$ext2_18?>" maxlength='70'  itemname="회사명" required></td></tr>
...
<font color=#BF3030><b> *** 전형방법/급여사항</b></font>
		<table width="100%" cellpadding="0" cellspacing="1" bgcolor=#CCCCCC>
...
<br><br>
<font color=#BF3030><b> **** 접수방법</b></font>
		<table width="100%" cellpadding="0" cellspacing="1" bgcolor=#CCCCCC>
...
<? if($w != "u") {?>
<!--광고-->
<font color=#BF3030><b> * 광고노출</b></font>(수정이 안되므로 신중히 선택하십시오.)&nbsp;*현재 <?=$member[mb_id]?>님의 포인트는  <font color=#FF0000><?=$member[mb_point]?></font>점입니다.
<br>
